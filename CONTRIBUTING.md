...
others on [GitHub Issues](https://github.com/metreeca/muse/issues), telling the world about Metreeca… ;-)

# Reporting Bugs

Before opening an [issue](https://github.com/metreeca/muse/issues) to report a bug, search open issues for similar cases
...
a [discussion](https://github.com/metreeca/muse/discussions) and describe your problem.

# Suggesting Features

Before opening an [issue](https://github.com/metreeca/muse/issues) to suggest a feature, search open issues for similar
